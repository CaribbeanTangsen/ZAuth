...
@Entity
@ApiModel("客户端组")
@Table(name = "client_group", indexes = {@Index(columnList = "tag", unique = true), @Index(columnList = "da_code")})
public class ClientGroupEntity implements TreeEntity<Long,Long> {
    /**
     * id
     */
    @Id
